## Christian Mayer:
## Similarly to unrolled.py, this is the fill_layer() function of the naive.py module with one modification:
## The recursive function calls are unrolled due to efficiency reasons. The difference to unrolled.py is that it seems
## to be generated by an external tool rather than by hand (but this is only my guess).
